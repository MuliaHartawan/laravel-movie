...
<body class="font-sans bg-gray-900 text-white">
    ...
    @yield('content')
    <footer class="border-t-2 border-gray-800 my-16 flex flex-col items-center space-y-1 py-8 text-center text-2xs text-neutral-400">
        ...
        <div class="flex items-center space-x-6">
            ...
            <a rel="me" target="_blank" data-external-link="true" href="hhttps://www.linkedin.com/in/mulia-hartawan-negara-b144881b7/" > <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16">
